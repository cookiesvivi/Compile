...
66:                                               ; preds = %60, %97
  %67 = phi i32 [ %69, %97 ], [ 0, %60 ]
  %68 = phi i32 [ %101, %97 ], [ 1, %60 ]
  %69 = phi i32 [ %70, %97 ], [ 1, %60 ]
  %70 = add nsw i32 %67, %69
  %71 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %70)
  %72 = bitcast %"class.std::basic_ostream"* %71 to i8**
  %73 = load i8*, i8** %72, align 8, !tbaa !5
  %74 = getelementptr i8, i8* %73, i64 -24
  %75 = bitcast i8* %74 to i64*
  %76 = load i64, i64* %75, align 8
  %77 = getelementptr inbounds %"class.std::basic_ostream", %"class.std::basic_ostream"* %71, i64 0, i32 1, i32 4
  %78 = bitcast %"class.std::basic_streambuf"** %77 to i8*
...
91:                                               ; preds = %84
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %81)
  ...
  %96 = call noundef signext i8 %95(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %81, i8 noundef signext 10)
  br label %97

97:                                               ; preds = %88, %91
  %98 = phi i8 [ %90, %88 ], [ %96, %91 ]
  %99 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %71, i8 noundef signext %98)
  %100 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %99)
...
define internal void @_GLOBAL__sub_I_fibonacci.cpp() #6 section ".text.startup" {

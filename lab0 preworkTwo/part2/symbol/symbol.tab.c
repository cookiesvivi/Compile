...
static const char *const yytname[] =
{
  ...
  "DIV", "UMINUS", "LEFT_PAREN", "RIGHT_PAREN", "NUMBER", "ID", "';'",
...
{
      -4,    16,    -4,    21,    21,    -4,     6,    -4,     9,    -1,
      -4,    -4,    30,    21,    -4,    21,    21,    21,    21,    -4,
      -4,     3,    12,    12,    -4,    -4
};
...
static const yytype_int8 yytable[] =
{
      ...
      21,    19,    22,    23,    24,    25,     2,    17,    18,    13,
       3,    14,     0,     0,     4,     3,     5,     6,     7,     4,
       0,     5,    10,    15,    16,    17,    18,     0,     0,    20
};
...
static const yytype_int8 yycheck[] =
{
      ...
      13,    12,    15,    16,    17,    18,     0,     5,     6,    13,
       4,    12,    -1,    -1,     8,     4,    10,    11,    12,     8,
      -1,    10,    11,     3,     4,     5,     6,    -1,    -1,     9
};
...
{
       0,    15,     0,     4,     8,    10,    11,    12,    16,    17,
      11,    17,    17,    13,    12,     3,     4,     5,     6,    12,
       9,    17,    17,    17,    17,    17
};
...
#line 55 "symbol.y"
                                        ...
                                        printf("%f\n",(yyvsp[-1].m_num) );}
#line 1116 "symbol.tab.c"
    break;

  case 6: /* assign: ID '=' expr  */
#line 64 "symbol.y"
                                       {symbolTable.insert((yyvsp[-2].m_id), (yyvsp[0].m_num));}
#line 1122 "symbol.tab.c"
    break;

  case 7: /* expr: expr ADD expr  */
#line 67 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[-2].m_num)+ (yyvsp[0].m_num);}
#line 1128 "symbol.tab.c"
    break;

  case 8: /* expr: expr MINUS expr  */
#line 68 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[-2].m_num) - (yyvsp[0].m_num);}
#line 1134 "symbol.tab.c"
    break;

  case 9: /* expr: expr MUL expr  */
#line 69 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[-2].m_num) * (yyvsp[0].m_num);}
#line 1140 "symbol.tab.c"
    break;

  case 10: /* expr: expr DIV expr  */
#line 70 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[-2].m_num) / (yyvsp[0].m_num);}
#line 1146 "symbol.tab.c"
    break;

  case 11: /* expr: LEFT_PAREN expr RIGHT_PAREN  */
#line 71 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[-1].m_num);}
#line 1152 "symbol.tab.c"
    break;

  case 12: /* expr: MINUS expr  */
#line 72 "symbol.y"
                                        {(yyval.m_num) = -(yyvsp[0].m_num);}
#line 1158 "symbol.tab.c"
    break;

  case 13: /* expr: NUMBER  */
#line 73 "symbol.y"
                                        {(yyval.m_num) = (yyvsp[0].m_num);}
#line 1164 "symbol.tab.c"
    break;

  case 14: /* expr: ID  */
#line 74 "symbol.y"
                                        {
                                        string id = (yyvsp[0].m_id);
                                        (yyval.m_num) = symbolTable.get(id);
                                        }
#line 1173 "symbol.tab.c"
    break;


#line 1177 "symbol.tab.c"

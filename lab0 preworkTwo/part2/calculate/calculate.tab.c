...
#line 30 "calculate.y"
                           {printf("%f\n", yyvsp[-1]);}
#line 1084 "calculate.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 35 "calculate.y"
                                        {yyval = yyvsp[-2] + yyvsp[0];}
#line 1090 "calculate.tab.c"
    break;

  case 6: /* expr: expr MINUS expr  */
#line 36 "calculate.y"
                                        {yyval = yyvsp[-2] - yyvsp[0];}
#line 1096 "calculate.tab.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 37 "calculate.y"
                                        {yyval = yyvsp[-2] * yyvsp[0];}
#line 1102 "calculate.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 38 "calculate.y"
                                        {yyval = yyvsp[-2] / yyvsp[0];}
#line 1108 "calculate.tab.c"
    break;

  case 9: /* expr: LEFT_PAREN expr RIGHT_PAREN  */
#line 39 "calculate.y"
                                        {yyval = yyvsp[-1];}
#line 1114 "calculate.tab.c"
    break;

  case 10: /* expr: MINUS expr  */
#line 40 "calculate.y"
                                        {yyval = -yyvsp[0];}
#line 1120 "calculate.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 41 "calculate.y"
                                        {yyval = yyvsp[0];}
#line 1126 "calculate.tab.c"
    break;


#line 1130 "calculate.tab.c"
